...
TARGET_RECOVERY_FSTAB := device/razer/cheryl/fstab.qcom
TARGET_RECOVERY_PIXEL_FORMAT := "RGBX_8888"
TARGET_RECOVERY_UI_BLANK_UNBLANK_ON_INIT := true
TARGET_USERIMAGES_USE_EXT4 := true
TARGET_RECOVERY_WIPE := device/razer/cheryl/recovery.wipe
...
RECOVERY_INSTALLER_PATH := device/razer/cheryl/installer
TW_USE_TOOLBOX := true
